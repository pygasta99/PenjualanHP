		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" role="form" id="form-stock">
				  ...
				  <div class="form-group">
				    <label class="control-label col-sm-3" for="">Tanggal Pembuatan:</label>
				    <div class="col-sm-9"> 
				  ...
				  <div class="form-group">
				    <label class="control-label col-sm-3" for="">Tanggal Pembelian:</label>
				    <div class="col-sm-9"> 
				  ...
				  <div class="form-group">
				    <label class="control-label col-sm-3" for="">Tanggal Garansi:</label>
				    <div class="col-sm-9"> 
